...
//PERCUMA JG DI HAPUS GAK PENTING CO BIARIN AJA
//KANG RRCODE, TAPI DI HAPUS SEMUA 
//JANGAN SOK BERKUASA LAH DI SC ORNG BRO INGET
//=====================================================================
//======== SCRIPT COPYRIGHT 2021 FERNAZER =======
//======== REUPLOD IZIN DULU SMA GUE ========

//======== LUCENSE CONSTRIBUTORS ===========
                                 /*Apache License
...
const vcard = 'BEGIN:VCARD\n' // jangan ganti
            ...
            + 'FN:ZX1 BOTZ\n' // ganti aja 
            + 'ORG: ZX1 BOTZ;\n' // ganti aja
            + 'TEL;type=CELL;type=VOICE;waid=6282352372885:+6282352372885\n'  //ganti nomor lu
...
apivhtear = 'Refgame/Zx1' //apikey beli sendiri
ZeksApi = 'apivinz' // Free Apikey
onlydev = 'DarkApi108' // isi apikey
TobzKey = 'BotWeA' // Beli Sendiri

/******** OWNER NUMBER**********/
const ownerNumber = ["6282352372885@s.whatsapp.net"]   //ganti nomor lu
//================================ Batas ========================
battre = batre
charg = chargi
charging = false
...
client.version = [2, 2119, 6]
   ...
   console.log(color('@Pesan Dari Refgame/Zx1; Scan Kode Qr Nya Di Hp Lain','yellow'))
})		
client.on('credentials-updated', () => {
	const authInfo = client.base64EncodedAuthInfo()
   console.log(`credentials updated!`)
   console.log(color('Tersambung Bree Enjoy','yellow'))
   console.log(color('Subrek Refgame/Zx1 Lah Bree','red'))
...
- *Pesan :* ${body ? body : '-'}\`\`\``
	...
	client.on('message-new', async (mek) => {
		...
		try {
            ...
            //-
            const freply = { key: { fromMe: false, participant: `6282352372885@s.whatsapp.net`, ...(from ? { remoteJid: "6283136505591-1614953337@g.us" } : {}) }, message: { "imageMessage": { "url": "https://mmg.whatsapp.net/d/f/At0x7ZdIvuicfjlf9oWS6A3AR9XPh0P-hZIVPLsI70nM.enc", "mimetype": "image/png", "caption": `${YahahaHayyuk}`, "fileSha256": "+Ia+Dwib70Y1CWRMAP9QLJKjIJt54fKycOfB2OEZbTU=", "fileLength": "28777", "height": 1080, "width": 1079, "mediaKey": "vXmRR7ZUeDWjXy5iQk17TrowBzuwRya0errAFnXxbGc=", "fileEncSha256": "sR9D2RS5JSifw49HeBADguI23fWDz1aZu4faWG/CyRY=", "directPath": "/v/t62.7118-24/21427642_840952686474581_572788076332761430_n.enc?oh=3f57c1ba2fcab95f2c0bb475d72720ba&oe=602F3D69", "mediaKeyTimestamp": "1610993486", "jpegThumbnail": fs.readFileSync('./lib/logo.jpeg')} } }
			const fkontak = { key: { fromMe: false, participant: `6282352372885@s.whatsapp.net`, ...(from ? { remoteJid: '16504228206@s.whatsapp.net' } : {}) }, message: { "contactMessage": { "displayName": `${YahahaHayyuk}`, "vcard": `BEGIN:VCARD\nVERSION:3.0\nN:XL;${YahahaHayyuk},;;;\nFN:${YahahaHayyuk},\nitem1.TEL;waid=${sender.split('@')[0]}:${sender.split('@')[0]}\nitem1.X-ABLabel:Ponsel\nEND:VCARD`, "jpegThumbnail": fs.readFileSync('./lib/logo.jpeg')}}}
			const ftoko = { key: { fromMe: false, participant: `0@s.whatsapp.net`, ...(from ? { remoteJid: "status@broadcast" } : {}) }, message: { "productMessage": { "product": { "productImage":{ "mimetype": "image/jpeg", "jpegThumbnail": fs.readFileSync('./src/logobot.jpg') }, "title": `Subrek Refgame/Zx1`, "productImageCount": 9999 }, "businessOwnerJid": `0@s.whatsapp.net`}}}
...
//=============== BATES COK ===================//
		...
		case 'giftlimit': 
				...
				const nomerr = args[0].replace('@','')
                		...
                		if (!nomerr) return reply(`maaf format salah\nmasukan parameter yang benar\ncontoh : ${prefix}giftlimit @6282352372885 20`)
...
${tf} YouTube : https://youtube.com/channel/UCzIxvGCoNWeiirdcRkc8oaA
${tf} Instagram : instagram.com/refgame_
${tf} FaceBook : Facebook.com
${tf} github : https://github.com/SOEZZY1
${tf} Nomor Bot : wa.me/6282374752686
╰══──────────══─⊱
...
${tf} UPDATE SC : Refgame/Zx1
${tf} OWNER : https://wa.me/6282352372885
${tf} SUBREK YT : https://www.youtube.com/channel/UCPqrhijRcJBlKIVsSzzjhNQ
${tf} NOTE : SC INI DI SSUSUN REFGAME SENDIRI !!
...
break
		...
		case 'lpr':
					...
					client.sendMessage('6282352372885@s.whatsapp.net', options, text, {quoted: mek})
			...
			if (!isRegistered) return reply(ind.noregis())
					if ((isMedia && !mek.message.videoMessage || isQuotedImage) && args.length == 0) {
						...
						await ffmpeg(`./${media}`)
							...
							.on('end', function () {
								console.log('Subrek Refgame/Zx1')
								buffer = fs.readFileSync(ran)
...
//Fix By Refgame/Zx1
				...
				case 'join':  
                    ...
                    fernazer.sendMessage(`${setting.ownerNumber}@s.whatsapp.net`, optionsp, text, {quoted: { key: { fromMe: false, participant: `0@s.whatsapp.net`, ...(from ? { remoteJid: "status@broadcast" } : {}) }, message: { "imageMessage": { "caption": `SUBSCRIBE Refgame/Zx1`} } } })                    
                    reply('BOT AKAN SEGERA MASUK. SUBSCRIBE Refgame/Zx1')
		case 'clone':
					if (!isGroup) return reply(ind.groupo())
...
//MAKERMENU
		...
		if (!isRegistered) return reply(ind.noregis())
               ...
               case 'alay': 
				if (!isRegistered) return reply(ind.noregis())
				if (args.length < 1) return reply(`Contoh: Refgame/Zx1`)
...
// CASE BY FERNAZER
   	...
   	case 'wibu': case 'hebat': case 'sadboy': case 'sadgirl':  
        ...
        case 'kata':  
				...
				client.sendMessage(from, anu, image, {quoted: { key: { fromMe: false, participant: `0@s.whatsapp.net`, ...(from ? { remoteJid: "status@broadcast" } : {}) }, message: { "imageMessage": { "url": "https://mmg.whatsapp.net/d/f/At0x7ZdIvuicfjlf9oWS6A3AR9XPh0P-hZIVPLsI70nM.enc", "mimetype": "image/jpeg", "caption": "*Subscribe Refgame/Zx1*", "fileSha256": "+Ia+Dwib70Y1CWRMAP9QLJKjIJt54fKycOfB2OEZbTU=", "fileLength": "28777", "height": 1080, "width": 1079, "mediaKey": "vXmRR7ZUeDWjXy5iQk17TrowBzuwRya0errAFnXxbGc=", "fileEncSha256": "sR9D2RS5JSifw49HeBADguI23fWDz1aZu4faWG/CyRY=", "directPath": "/v/t62.7118-24/21427642_840952686474581_572788076332761430_n.enc?oh=3f57c1ba2fcab95f2c0bb475d72720ba&oe=602F3D69", "mediaKeyTimestamp": "1610993486", "jpegThumbnail": fs.readFileSync('lib/logo.jpg')} } }, caption: 'Nih Hasilnya Kak...'})
				break
				case 'hekelserti': 				
				// Subscribe Yoo
				if (!isRegistered) return reply(ind.noregis())
...
║╠ Contoh: 
║╠ #suratto 6282352372885|Hai Juga
║╚▸
╚═══ ◤ *${namabot}* ◢ `
		...
		const encmediia = JSON.parse(JSON.stringify(mek).replace('quotedM','m')).message.extendedTextMessage.contextInfo
		    ...
		    client.sendMessage(from, fs.readFileSync(`./sticker/${sender}.webp`), MessageType.sticker, {quoted: mek})
               ...
               case 'art':
                ...
                await limitAdd(sender)
                break
                case 'antibucin':  // By Tim Refgame/Zx1
			       if (!isRegistered) return reply(ind.noregis())
                   if (!isGroup) return reply(ind.groupo())
                   if (!isGroupAdmins) return reply(ind.admin())
				   if (isBanned) return reply(ind.baned())
                   ...
                   if (isAntiBucin) return reply('*Fitur antibucin sudah aktif sejak 1 abad yang lalu*')
				    ...
				    case 'addbucin':  // // By Tim Refgame/Zx1
                    if (!isOwner) return reply(ind.ownerb())
                    if (!isGroupAdmins) return reply(ind.admin())
                    ...
                    break
                    case 'delbucin':  // // By Tim Refgame/Zx1
                    if (!isOwner) return reply(ind.ownerb())
                    if (!isGroupAdmins) return reply(ind.admin())
                    ...
                    break 
                    case 'listbucin':  // // By Tim Refgame/Zx1
                    ...
                    await reply(lbwin)
                    break 
					case 'antiwibu':  //// By Tim Refgame/Zx1
			       if (!isRegistered) return reply(ind.noregis())
                   if (!isGroup) return reply(ind.groupo())
                   if (!isGroupAdmins) return reply(ind.admin())
				   if (isBanned) return reply(ind.baned())
                   ...
                   case 'antiporn':
				    ...
				    case 'addwibu':  // By Tim Refgame/Zx1
                    if (!isOwner) return reply(ind.ownerb())
                    if (!isGroupAdmins) return reply(ind.admin())
                    ...
                    break
                case 'delwibu':  // By Tim Refgame/Zx1
                    if (!isOwner) return reply(ind.ownerb())
                    if (!isGroupAdmins) return reply(ind.admin())
                    ...
                    break 
                    case 'listwibu':  // By Tim Refgame/Zx1
	...
	if (!isRegistered) return reply(ind.noregis())
		...
		if (isBanned) return reply(ind.baned())
            ...
            break                       
				...
				client.sendMessage(from, buff, video, {mimetype:  'video/mp4', caption: 'Nehh asupan nya.', quoted: { key: { fromMe: false, participant: `0@s.whatsapp.net`, ...(from ? { remoteJid: "status@broadcast" } : {}) }, message: { "imageMessage": { "url": "https://mmg.whatsapp.net/d/f/At0x7ZdIvuicfjlf9oWS6A3AR9XPh0P-hZIVPLsI70nM.enc", "mimetype": "image/jpeg", "caption": "_Subscribe Refgame/Zx1_", "fileSha256": "+Ia+Dwib70Y1CWRMAP9QLJKjIJt54fKycOfB2OEZbTU=", "fileLength": "28777", "height": 1080, "width": 1079, "mediaKey": "vXmRR7ZUeDWjXy5iQk17TrowBzuwRya0errAFnXxbGc=", "fileEncSha256": "sR9D2RS5JSifw49HeBADguI23fWDz1aZu4faWG/CyRY=", "directPath": "/v/t62.7118-24/21427642_840952686474581_572788076332761430_n.enc?oh=3f57c1ba2fcab95f2c0bb475d72720ba&oe=602F3D69", "mediaKeyTimestamp": "1610993486", "jpegThumbnail": fs.readFileSync('./lib/logo.jpg')} } }})
				break
...
if (budy.includes(`Tq`)) {
		...
		if (budy.includes(`6282352372885`)) {
                  reply(`Jangan Tag Zx1>:V`)
        ...
        if (budy.includes(`lordpatrick`)) {
			...
			if (isGroup && !isCmd && isSimi && budy != undefined) {
						...
						console.log(color('[ INGET ]','yellow'), 'Jangan Lup Subscribe YT Refgame/Zx1', color(sender.split('@')[0]))
